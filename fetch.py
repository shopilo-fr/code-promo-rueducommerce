#!/usr/bin/env python3
"""
Recuperation des codes promo Rue du Commerce depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/rueducommerce.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/rueducommerce.fr"
STORE_NAME = "Rue du Commerce"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour Rue du Commerce depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-rueducommerce)"
    }
    try:
